...
func (r *Registry) Register(ctx context.Context, si *registry.ServiceInstance) error {
	...
	for _, endpoint := range si.Endpoints {
		...
		si.Metadata["service-type"] = "Go"
		si.Metadata["paas-name"] = si.Name
		si.Metadata["paas-ns"] = os.Getenv("PAAS_NS")
		si.Metadata["paas-tenant"] = os.Getenv("PAAS_TENANT")
		si.Metadata["cluster-id"] = os.Getenv("CLUSTER_ID")
		si.Metadata["component-ns"] = os.Getenv("COMPONENT_NS")
